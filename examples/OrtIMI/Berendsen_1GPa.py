...
--- SETTINGS ---
MLIP Model: MACE-MH-1 (Multi-head Foundation) - Non-linear ⭐
MACE Head: omat_pbe
...
def main():
    ...
    try:
        ...
        print(f"🎯 Head: omat_pbe")
        print(f"🔬 Dispersion: D3-pbe")
        ...
        print(f"✅ MACE foundation model initialized on cuda")

    except Exception as e:
        print(f"❌ MACE initialization failed on cuda: {e}")
