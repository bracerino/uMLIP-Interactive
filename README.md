...
Run basic molecular dynamics/static simulations (single-point energy, geometry optimization, elastic properties, phonons) in an interactive interface for multiple input files structures (POSCAR, CIF, LMP, XYZ with lattice) with a machine learning MACE MP interatomic potential.
