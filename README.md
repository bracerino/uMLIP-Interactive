...
- 🎥 **For using the generated Python script for the calculations at [YouTube](https://youtu.be/w6hmvzC2J-8?si=9BYWJuUg7pohL1sw)**.   
- 🎥 **For calculating phonons [YouTube](https://www.youtube.com/watch?v=XG3N1fjijfA)**.
- 🎥 **For running MD [YouTube](https://www.youtube.com/watch?v=dKhu1kIuGso)**.
